...
model_size = "medium"
# Initialize lazily; prefer CPU on Apple Silicon (CTranslate2 has no CUDA/MPS here)
model = None
def split_audio_whisper(audio_path, audio_name, target_dir='processed'):
    global model
    if model is None:
        # Use CPU backend; int8 quantization is faster on CPU and avoids CUDA requirement
